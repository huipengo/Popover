...
- (IBAction)buttonAction:(UIButton *)sender {
    ...
    [popoverView showToView:sender actions:[self QQActions]];
}
...
- (IBAction)leftBarItemAction:(UIBarButtonItem *)sender {
    ...
    [popoverView showToPoint:CGPointMake(20, 64) actions:@[action1, action2, action3, action4]];
}
...
- (IBAction)showWithoutImage:(UIButton *)sender {
    ...
    [popoverView showToView:sender actions:@[action1, action2, action3, action4, action5, action6]];
}
